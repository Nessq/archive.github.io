...
$(window).on('load', function() {
  ...
  $('#main-example .label').each(function(){
		if($(this).parent().hasClass('days')){
			$(this).html('Дней');
		}
		if($(this).parent().hasClass('hours')){
			$(this).html('Часов');
		}
		if($(this).parent().hasClass('minutes')){
			$(this).html('Минут');
		}
		if($(this).parent().hasClass('seconds')){
			$(this).html('Секунд');
		}
	});
});
...
$(function(){
  var $tr = $('.price-table__table tbody tr');
  var $tl = $('.table-link a');
  $tr.click(function(){
    var i = $(this).index();
    $('.table-link a')[i].click();
  });
});
